...
#nullable disable
    internal class ByteBankAtendimento
    {
        ...
        private void ExportarEmXML()
        {
            ...
            {
                Console.WriteLine("Não possui dados para exportação");
                Console.ReadKey();
            }
            else
            {
                try
                {
                    ...
                    FileStream fs = new FileStream(@"D:\Estudos alura\Curso Bibliotecas\Arquivos Gerados\arquivo.xml", FileMode.Create);
        ...
        private void ExportarContas()
        {
            ...
            else
            {
                ...
                try
                {
                    FileStream fs = new FileStream(@"D:\Estudos alura\Curso Bibliotecas\Arquivos Gerados\contas.json", FileMode.Create);
                    using (StreamWriter streamwriter = new StreamWriter(fs))
                    {
                        streamwriter.WriteLine(json);
                    }
                    Console.WriteLine(@"Arquivo salvo em D:\Estudos alura\Curso Bibliotecas\Arquivos Gerados");
                    Console.ReadKey();
                }
                catch (Exception excecao)
                {
